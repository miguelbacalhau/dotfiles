		...
		config = function()
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					map("<leader>t", require("telescope.builtin").lsp_type_definitions, "Go to [T]ype Definition")

					--- Show hover info
					map("<leader>h", vim.lsp.buf.hover, "Show [H]over")

					--- Diagnostics
					map("<leader>e", require("telescope.builtin").diagnostics, "[S]earch [D]iagnostics")
